...
where each existing tool remains accessible. The optional keep-open advanced
view is a presentation preference, not a new role, product phase or application.
Navigation labels, model visibility, and action labels are explicit proposed
